...
const STRINGS: Record<Locale, Dict> = {
  en: {
    ...
    'share.sharing': 'Opening Outlook…',
    'share.failed': 'Sharing failed',
    'share.mailBody': 'Please find attached the wiki page “{name}”.',
    'view.read': 'Read',
    'view.edit': 'Edit',
    'view.source': 'Source',
    'view.graph': 'Graph',
    ...
    'sidebar.clientsSelected': '{count} clients selected',
    'meddpicc.statusLabel': 'Status: {status}',
    ...
    'backlinks.collapse': 'Collapse links panel',
    'backlinks.expand': 'Show links panel',
    'backlinks.resize': 'Resize links panel (drag, or arrow keys)',
    ...
    'graph.hierarchy': 'Hierarchy view',
    'graph.sponsor': 'Sponsor',
    'graph.detractor': 'Detractor',
    'graph.advisor': 'Trusted advisor',
    'graph.managerTooltip': 'Potential N+1: {manager}',
    'graph.managerMissing': 'Potential N+1 not provided',
    'graph.linkLegend': 'Link types',
    'graph.linkStructure': 'Account membership',
    'graph.linkHierarchy': 'Potential N+1',
    'graph.linkInfluence': 'Influence',
    'graph.linkCooccurrence': 'Co-occurrence',
  ...
  fr: {
    ...
    'share.sharing': 'Ouverture d’Outlook…',
    'share.failed': 'Échec du partage',
    'share.mailBody': 'Veuillez trouver ci-joint la page de wiki « {name} ».',
    'view.read': 'Lecture',
    'view.edit': 'Édition',
    'view.source': 'Source',
    'view.graph': 'Graphe',
    ...
    'sidebar.clientsSelected': '{count} clients sélectionnés',
    'meddpicc.statusLabel': 'Statut : {status}',
    ...
    'backlinks.collapse': 'Réduire le panneau des liens',
    'backlinks.expand': 'Afficher le panneau des liens',
    'backlinks.resize': 'Redimensionner le panneau des liens (glisser ou flèches)',
    ...
    'graph.cooccurrence': 'Co-occurrence',
    'graph.hierarchy': 'Vue hiérarchique',
    'graph.sponsor': 'Sponsor',
    'graph.detractor': 'Détracteur',
    'graph.advisor': 'Trusted advisor',
    'graph.managerTooltip': 'N+1 potentiel : {manager}',
    'graph.managerMissing': 'N+1 potentiel non renseigné',
    'graph.linkLegend': 'Types de liens',
    'graph.linkStructure': 'Appartenance au compte',
    'graph.linkHierarchy': 'N+1 potentiel',
    'graph.linkInfluence': 'Influence',
    'graph.linkCooccurrence': 'Cooccurrence',
