...
const STRINGS: Record<Locale, Dict> = {
  en: {
    ...
    'graph.labels': 'Labels',
    'graph.links': 'Links shown',
    'graph.linksAll': 'All links',
    'graph.linksClassic': 'Classic only',
    'graph.linksInfluence': 'Influence only',
    'graph.cooccurrence': 'Co-occurrence',
    'graph.sponsor': 'Sponsor',
    'graph.detractor': 'Detractor',
    'graph.advisor': 'Trusted advisor',
  ...
  fr: {
    ...
    'graph.links': 'Liens affichés',
    'graph.linksAll': 'Tous les liens',
    'graph.linksClassic': 'Classiques',
    'graph.linksInfluence': "Influence",
    'graph.cooccurrence': 'Co-occurrence',
    'graph.sponsor': 'Sponsor',
    'graph.detractor': 'Détracteur',
    'graph.advisor': 'Trusted advisor',
